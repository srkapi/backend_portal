package com.srkapi.common.constants;

public class ConfigConstants {

	public static final String IMAGE_UPLOAD_LOCATION = "${image.upload.location}";
	public static final String IMAGE_VEHICLE_EXTERIOR_UPLOAD_LOCATION = "vehicle_exterior_images";
	public static final String IMAGE_VEHICLE_INTERIOR_UPLOAD_LOCATION = "vehicle_interior_images";
